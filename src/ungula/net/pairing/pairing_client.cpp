...
StoredPairing PairingClient::loadStoredPairing()
{
        ...
        if (channelValid) {
                ...
                uint8_t fallbackCh = (scanChannels_ && scanChannelCount_ > 0) ? scanChannels_[0] :
                                                                                1;
...
bool PairingClient::handleReceived(const ungula::net::comm::MacAddress &srcMac, const uint8_t *data,
